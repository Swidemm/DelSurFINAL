        ...
        <div class="reveal">
          ...
          <div class="space-y-6">
            <div class="flex items-start gap-4">
                ...
                <div><h4 class="font-bold text-delsur-blue">Teléfono / WhatsApp</h4><p class="text-slate-600">+54 9 11 6704-0733</p><a href="https://wa.me/5491167040733" class="text-delsur-orange text-sm font-semibold hover:underline">Enviar mensaje ahora</a></div>
            </div>
            <div class="flex items-start gap-4">
                <div class="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-sm text-delsur-orange"><svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg></div>
                <div><h4 class="font-bold text-delsur-blue">Email</h4><p class="text-slate-600">delsur.constr@gmail.com</p></div>
            </div>
          </div>
        </div>
